...
- Be able to publish a static webpage on GitHub Pages.
- Extend their understanding of use of images, color, and text formatting to style an HTML page, as measured by successful completion of the readings and daily code assignment.
